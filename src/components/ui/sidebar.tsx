  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-background data-[active=true]:shadow data-[active=true]:text-sidebar-primary data-[active=true]:font-medium data-[active=true]:border ",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
